...
type User struct {
	...
	AvatarUrl            string         `json:"avatar_url" gorm:"type:varchar(255);column:avatar_url" validate:"max=255"`
	ProfileUpdatedAt     int64          `json:"profile_updated_at" gorm:"type:bigint;default:0;column:profile_updated_at"`
	DisplayNameUpdatedAt int64          `json:"display_name_updated_at" gorm:"type:bigint;default:0;column:display_name_updated_at"`
	AvatarUpdatedAt      int64          `json:"avatar_updated_at" gorm:"type:bigint;default:0;column:avatar_updated_at"`
...
func (user *User) UpdateProfile(updatePassword bool, updateDisplayNameTimestamp bool, updateAvatarTimestamp bool) error {
	var err error
	if updatePassword {
		user.Password, err = common.Password2Hash(user.Password)
		if err != nil {
	...
	if updateDisplayNameTimestamp || updateAvatarTimestamp {
		updates["profile_updated_at"] = user.ProfileUpdatedAt
	}
	if updateDisplayNameTimestamp {
		updates["display_name_updated_at"] = user.DisplayNameUpdatedAt
	}
	if updateAvatarTimestamp {
		updates["avatar_updated_at"] = user.AvatarUpdatedAt
	}
	...
	return updateUserCache(currentUser)
}
